    ...
    <Link href={`/mountain/${mountain.sys.id}`} className="block">
      <div 
        className={`
          ...
          hover:-translate-y-1 hover:shadow-2xl hover:border-emerald-500
          ${compact ? 'h-70' : 'h-96'}
        `}
      >
      {/* Image Section */}
      ...
      >
        {mountain.headerImage?.url ? (
          ...
          <div 
            className="w-full h-full bg-gradient-to-br from-emerald-800 via-emerald-700 to-emerald-600 flex items-center justify-center relative"
          >
      ...
      >
        {/* Mountain Icon Badge */}
        <div className="absolute -top-3 right-5 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center shadow-lg">
